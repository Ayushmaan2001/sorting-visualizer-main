      ...
      >
        <div className='desc'>
          <Col span={14}><h1 style={{ color: 'orange'}}>Description</h1>
            <h2 style={{ color: 'white' }}>Comb Sort is an iterative sorting algorithm that imitates the movement of bubbles in sparkling water. The bubbles represents the elements of the data structure.</h2>
